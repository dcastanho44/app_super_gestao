...
class CreateUnidadesTable extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::table('produto_detalhes', function(Blueprint $table) {
            $table->dropForeign('produto_detalhes_unidade_id_foreign'); //removendo a fk [table]_[coluna]_[foreign]
            
            $table->dropColumn('unidade_id'); //remover a coluna
        });
        //remover o relacionamento com a tabela produtos
        Schema::table('produtos', function(Blueprint $table) {
            $table->dropForeign('produtos_unidade_id_foreign'); //removendo a fk [table]_[coluna]_[foreign]
